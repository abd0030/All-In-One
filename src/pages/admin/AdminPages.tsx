          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-r from-blue-500/10 via-indigo-500/10 to-purple-500/10 border border-blue-200 dark:border-blue-800/60 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2 self-end sm:self-center shrink-0">
                <button
                  onClick={() => {
                    const sqlScript = `-- 1. Create Payment Accounts Table with user_id
...
CREATE POLICY "Allow all to select payment accounts" ON public.payment_accounts FOR SELECT USING (true);
...
CREATE POLICY "Allow authenticated to insert payment accounts" ON public.payment_accounts FOR INSERT WITH CHECK (true);
...
CREATE POLICY "Allow users to update payment accounts" ON public.payment_accounts FOR UPDATE USING (true);
...
CREATE POLICY "Allow users to delete payment accounts" ON public.payment_accounts FOR DELETE USING (true);
